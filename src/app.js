...
app.get('/facebook-login', (req, res) => {
    res.redirect(`https://www.facebook.com/v8.0/dialog/oauth?client_id=${FACEBOOK_CLIENT_ID}&redirect_uri=${encodeURIComponent('http://localhost:3000/facebook-oauth-redirect')}&response_type=code&scope=pages_show_list,instagram_basic,business_management"`)
      /* <html>
        <body>
          <a href="https://www.facebook.com/v3.2/dialog/oauth?client_id=${FACEBOOK_CLIENT_ID}&redirect_uri=${encodeURIComponent('http://localhost:3000/oauth-redirect')}&response_type=code&scope=pages_show_list,instagram_basic,business_management"}">
